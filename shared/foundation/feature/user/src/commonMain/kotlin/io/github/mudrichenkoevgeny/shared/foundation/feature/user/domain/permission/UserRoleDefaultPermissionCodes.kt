...
object UserRoleDefaultPermissionCodes {
    ...
    val STAFF: Set<UserPermissionCode> = setOf(
        ...
        UserIdentifierPermissionCodes.USER_IDENTIFIER_DELETE_FOR_USER,
        UserIdentifierPermissionCodes.USER_IDENTIFIER_MASKED_GET_LIST_OF_USER,
        UserSessionPermissionCodes.USER_SESSION_DELETE_FOR_USER,
        UserSessionPermissionCodes.USER_SESSION_MASKED_GET_LIST_OF_USER,
    ...
    val ADMIN: Set<UserPermissionCode> = setOf(
        ...
        UserIdentifierPermissionCodes.USER_IDENTIFIER_DELETE_FOR_USER,
        UserIdentifierPermissionCodes.USER_IDENTIFIER_DELETE_FOR_STAFF,
        UserIdentifierPermissionCodes.USER_IDENTIFIER_MASKED_GET_LIST_OF_USER,
        UserIdentifierPermissionCodes.USER_IDENTIFIER_MASKED_GET_LIST_OF_STAFF,
        UserIdentifierPermissionCodes.USER_IDENTIFIER_UNMASKED_GET_LIST_OF_USER,
        UserIdentifierPermissionCodes.USER_IDENTIFIER_UNMASKED_GET_LIST_OF_STAFF,
        UserSessionPermissionCodes.USER_SESSION_DELETE_FOR_USER,
        UserSessionPermissionCodes.USER_SESSION_DELETE_FOR_STAFF,
        UserSessionPermissionCodes.USER_SESSION_MASKED_GET_LIST_OF_USER,
        UserSessionPermissionCodes.USER_SESSION_MASKED_GET_LIST_OF_STAFF,
        UserSessionPermissionCodes.USER_SESSION_UNMASKED_GET_LIST_OF_USER,
        UserSessionPermissionCodes.USER_SESSION_UNMASKED_GET_LIST_OF_STAFF,
        UserAuditPermissionCodes.USER_AUDIT_MASKED_READ_FOR_USER,
