...
/**
 * DTO representing a user identifier visible in admin endpoints with unmasked sensitive value.
 *
 ...
 * @property identifier The raw login value (e.g., email address, phone number, or external ID).
 ...
 */
@Serializable
data class UserIdentifierUnmaskedResponse(
