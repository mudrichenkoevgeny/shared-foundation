package io.github.mudrichenkoevgeny.shared.foundation.core.security.domain.model.audit.resource
...
enum class SecurityAuditResourceType : AuditResourceType {
    /** [ManagementSecuritySettingsRoutes.UPDATE_SECURITY_SETTINGS] request/response payload. */
    SECURITY_SETTINGS;
    ...
    override val serialName: String
        get() = when (this) {
            SECURITY_SETTINGS -> RESOURCE_SECURITY_SETTINGS
        }
