 ...
 */
enum class AuditEventMetadataValueSensitivity {
    /**
    ...
    /**
     * String representation of the [AuditEventMetadataValueSensitivity] for API wire values (snake_case).
     */
    ...
    companion object {
        ...
        /**
         * Returns [AuditEventMetadataValueSensitivity] based on the provided string value, or null if the value is invalid.
         */
        fun fromValueOrNull(value: String): AuditEventMetadataValueSensitivity? =
            runCatching { valueOf(value.uppercase()) }.getOrNull()

        /**
         * Returns [AuditEventMetadataValueSensitivity] for the given wire or enum-style string (case-insensitive enum name).
         *
         * @throws IllegalArgumentException if [value] does not match any [AuditEventMetadataValueSensitivity].
         */
        fun fromValueOrThrow(value: String): AuditEventMetadataValueSensitivity =
