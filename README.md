...
```
implementation(platform(io.github.mudrichenkoevgeny:shared-foundation-bom:0.0.17))
...
// Or if you don`t wan`t to use bom:
implementation("io.github.mudrichenkoevgeny:shared-foundation-core-common:0.0.17")
implementation("io.github.mudrichenkoevgeny:shared-foundation-core-security:0.0.17")
implementation("io.github.mudrichenkoevgeny:shared-foundation-core-settings:0.0.17")
implementation("io.github.mudrichenkoevgeny:shared-foundation-feature-user:0.0.17")
```
